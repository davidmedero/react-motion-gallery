...
const entryPoints: EntryPoint[] = [
  ...
  {
    category: "Layout",
    entry: "react-motion-gallery/masonry/measured",
    imports: "Masonry, Masonry.Item",
    description: "Measured masonry for arbitrary cards, fullscreen, and plugins.",
  },
  {
    category: "Layout",
    entry: "react-motion-gallery/masonry/measured/ready",
    imports: "useMasonryReady",
    description: "Readiness hook for measured masonry layouts.",
  },
  {
    category: "Layout",
  ...
  {
    category: "Data",
    entry: "react-motion-gallery/entries/cache",
    imports: "CachedEntries",
    description: "Entries wrapper with opt-in skeleton snapshot caching.",
  },
  {
  ...
  {
    category: "Loading",
    entry: "react-motion-gallery/skeleton/masonry/structured",
    imports: "MasonrySkeleton",
    description: "Structured masonry skeleton with text/layout prediction.",
  },
  {
    category: "Loading",
  ...
  {
    category: "Loading",
    entry: "react-motion-gallery/skeleton/cache/grid",
    imports: "CachedGridSkeleton",
    description: "Grid skeleton wrapper with opt-in snapshot caching.",
  },
  {
    category: "Loading",
    entry: "react-motion-gallery/skeleton/cache/masonry",
    imports: "CachedMasonrySkeleton",
    description: "Lightweight masonry skeleton wrapper accepting cache-shaped props.",
  },
  {
    category: "Loading",
    entry: "react-motion-gallery/skeleton/cache/masonry/structured",
    imports: "CachedMasonrySkeleton",
    description: "Structured masonry skeleton wrapper with opt-in snapshot caching.",
  },
  {
    category: "Loading",
...
const entryPointTabs = [
  ...
  },
  {
    ...
    code: [
      ...
      'import { Masonry as MeasuredMasonry } from "react-motion-gallery/masonry/measured";',
      'import { useMasonryReady as useMeasuredMasonryReady } from "react-motion-gallery/masonry/measured/ready";',
  ...
  },
  {
    ...
    code: [
      ...
      'import { CachedMasonrySkeleton } from "react-motion-gallery/skeleton/cache/masonry";',
      'import { CachedMasonrySkeleton as StructuredCachedMasonrySkeleton } from "react-motion-gallery/skeleton/cache/masonry/structured";',
