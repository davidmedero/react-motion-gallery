...
const entryPoints: EntryPoint[] = [
  ...
  },
  {
    ...
    imports: "Slider, createSliderIndexChannel, SliderVirtualizationOptions",
    description: "Ergonomic slider with a small core, lazy extended behavior, and fixed-track virtualization.",
  },
  {
    category: "Layout",
  ...
  },
  {
    ...
    imports: "useFullscreenController and fullscreen dialog types",
    description: "Fullscreen controller hook, dialog handoff methods, and shared fullscreen option types.",
  },
  {
    category: "Fullscreen",
    entry: "react-motion-gallery/fullscreen/slider",
    imports: "fullscreenSlider",
    description: "Fullscreen slider runtime plugin with motion, gap, and virtualization options.",
  },
  {
    category: "Fullscreen",
  ...
  },
  {
    ...
    imports: "ThumbnailSlider, thumbnail sync helpers, virtualization types",
    description: "Synced thumbnail rails for base sliders, render-prop thumbnail data, and large rail virtualization.",
  },
  {
    category: "Navigation",
    entry: "react-motion-gallery/fullscreenThumbnails",
    imports: "FullscreenThumbnailSlider and props",
    description: "Thumbnail strips that connect directly to fullscreen state, including virtualized large fullscreen rails.",
  },
  {
    category: "Media",
