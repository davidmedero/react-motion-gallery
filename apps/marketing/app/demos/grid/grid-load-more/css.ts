...
.placeholderSlot:global([data-rmg-grid-item-reveal="1"]:not([data-rmg-grid-item-compare="1"]))
  > :global([data-rmg-grid-item-skeleton="true"]) {
  opacity: 1 !important;
  transition-delay: 0ms !important;
  transition-duration: 0ms !important;
}
.placeholderSlot:global([data-rmg-grid-item-layered="1"])
  > :global([data-rmg-grid-item-content="true"]) {
  opacity: 0 !important;
