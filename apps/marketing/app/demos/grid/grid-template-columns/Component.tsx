...
const ITEMS: DemoItem[] = [
  {
    imageSrc: "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=1800&h=1240&q=80",
    fullscreenSrc: "https://images.unsplash.com/photo-1470770841072-f978cf4d019e?auto=format&fit=crop&w=2400&h=1653&q=80",
  ...
  {
    imageSrc: "https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?auto=format&fit=crop&w=1200&h=1500&q=80",
    fullscreenSrc: "https://images.unsplash.com/photo-1483728642387-6c3bdd6c93e5?auto=format&fit=crop&w=2400&h=3000&q=80",
  ...
  {
    imageSrc: "https://images.unsplash.com/photo-1523712999610-f77fbcfc3843?auto=format&fit=crop&w=1800&h=1125&q=80",
    fullscreenSrc: "https://images.unsplash.com/photo-1523712999610-f77fbcfc3843?auto=format&fit=crop&w=2400&h=1500&q=80",
  ...
  {
    imageSrc: "https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1200&h=1500&q=80",
...
const TEMPLATE_COLUMNS = {
  ...
  1200: "minmax(0, 1.42fr) minmax(148px, 0.48fr) minmax(0, 1.08fr) minmax(180px, 0.42fr)",
};
...
function createTemplateSkeletonItem(
  item: DemoItem,
  index: number,
): SkeletonNode {
...
function TemplateColumnsTile(props: { item: DemoItem; index: number }) {
  const { item } = props;
