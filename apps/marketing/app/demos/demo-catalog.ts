...
export const DEMO_METADATA = [
  ...
  { id: "slider-virtualization", title: "Virtualization", eyebrow: "Slider", tags: ["virtualization", "lazy-load", "loop", "scrollbar", "crossfade", "fullscreen"], categoryId: "slider" },
  ...
  { id: "grid-pagination", title: "Server Pagination", eyebrow: "Grid Data", tags: ["api", "pagination", "server", "dummyjson"], categoryId: "grid" },
  { id: "grid-pagination-client", title: "Client Pagination", eyebrow: "Grid Data", tags: ["api", "pagination", "client", "dummyjson"], categoryId: "grid" },
  { id: "grid-load-more", title: "Load More", eyebrow: "Grid Data", tags: ["api", "load-more", "dummyjson"], categoryId: "grid" },
  { id: "grid-infinite-scroll", title: "Infinite Scroll", eyebrow: "Grid Data", tags: ["api", "infinite-scroll", "dummyjson"], categoryId: "grid" },
  { id: "grid-virtualization", title: "Virtualization", eyebrow: "Grid Data", tags: ["api", "virtualization", "dummyjson"], categoryId: "grid" },
  ...
  { id: "masonry-core-balanced", title: "Balanced", eyebrow: "Masonry Core", tags: ["images", "balanced", "fullscreen", "skeleton", "core"], categoryId: "masonry" },
  { id: "masonry-core-spans", title: "Spans", eyebrow: "Masonry Core", tags: ["images", "balanced", "span", "fullscreen", "skeleton", "core"], categoryId: "masonry" },
  { id: "masonry-core-horizontal-order", title: "Horizontal Order", eyebrow: "Masonry Core", tags: ["images", "horizontal-order", "span", "fullscreen", "skeleton", "core"], categoryId: "masonry" },
  { id: "masonry-core-round-robin", title: "Round Robin", eyebrow: "Masonry Core", tags: ["images", "round-robin", "fullscreen", "skeleton", "core"], categoryId: "masonry" },
  { id: "masonry-core-lazy-load", title: "Lazy Load", eyebrow: "Masonry Core", tags: ["images", "lazy-load", "fullscreen", "skeleton", "core"], categoryId: "masonry" },
  { id: "masonry-pagination", title: "Server Pagination", eyebrow: "Masonry Data", tags: ["api", "pagination", "server", "dummyjson"], categoryId: "masonry" },
  { id: "masonry-pagination-client", title: "Client Pagination", eyebrow: "Masonry Data", tags: ["api", "pagination", "client", "dummyjson"], categoryId: "masonry" },
  { id: "masonry-load-more", title: "Load More", eyebrow: "Masonry Data", tags: ["api", "load-more", "dummyjson"], categoryId: "masonry" },
  { id: "masonry-infinite-scroll", title: "Infinite Scroll", eyebrow: "Masonry Data", tags: ["api", "infinite-scroll", "dummyjson"], categoryId: "masonry" },
  { id: "masonry-virtualization", title: "Virtualization", eyebrow: "Masonry Data", tags: ["api", "virtualization", "dummyjson"], categoryId: "masonry" },
  ...
  { id: "entries-pagination", title: "Server Pagination", eyebrow: "Entries Data", tags: ["api", "pagination", "server", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-pagination-client", title: "Client Pagination", eyebrow: "Entries Data", tags: ["api", "pagination", "client", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-load-more", title: "Load More", eyebrow: "Entries Data", tags: ["api", "load-more", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-infinite-scroll", title: "Infinite Scroll", eyebrow: "Entries Data", tags: ["api", "infinite-scroll", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-virtualization", title: "Virtualization", eyebrow: "Entries Data", tags: ["api", "virtualization", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-pagination-grid", title: "Server Pagination Grid", eyebrow: "Entries Data", tags: ["api", "pagination", "server", "grid", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-pagination-grid-client", title: "Client Pagination Grid", eyebrow: "Entries Data", tags: ["api", "pagination", "client", "grid", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-load-more-grid", title: "Load More Grid", eyebrow: "Entries Data", tags: ["api", "load-more", "grid", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-infinite-scroll-grid", title: "Infinite Scroll Grid", eyebrow: "Entries Data", tags: ["api", "infinite-scroll", "grid", "ready", "dummyjson"], categoryId: "entries" },
  { id: "entries-virtualization-grid", title: "Virtualization Grid", eyebrow: "Entries Data", tags: ["api", "virtualization", "grid", "ready", "dummyjson"], categoryId: "entries" },
  ...
  { id: "fullscreen-dialog", title: "Dialog", eyebrow: "Fullscreen", tags: ["dialog", "captions", "thumbnails", "transition"], categoryId: "fullscreen" },
...
export const DEMO_CATEGORIES = [
  {
    ...
    items: [
      ...
      { type: "demo", demoId: "slider-virtualization" },
  ...
  },
  {
    ...
    label: "Grid",
    description:
      "Predictable media grids with responsive spans, data plugins, and fullscreen handoffs built into the layout.",
    items: [
  ...
  },
  {
    ...
    label: "Masonry",
    description:
      "Dimensioned core masonry for small image grids, data plugins, plus measured masonry demos for richer cards, video, fullscreen, and structured skeleton loading.",
    items: [
      { type: "demo", demoId: "masonry-core-balanced" },
      { type: "demo", demoId: "masonry-core-spans" },
      { type: "demo", demoId: "masonry-core-horizontal-order" },
      { type: "demo", demoId: "masonry-core-round-robin" },
      { type: "demo", demoId: "masonry-core-lazy-load" },
      {
        type: "group",
        id: "masonry-data",
        label: "Data",
  ...
  },
  {
    ...
    items: [
      ...
      { type: "demo", demoId: "fullscreen-dialog" },
