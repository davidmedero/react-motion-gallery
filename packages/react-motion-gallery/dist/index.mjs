...
import React26, { useState as useState10, useEffect as useEffect21, useRef as useRef14, useCallback as useCallback13, useMemo as useMemo11, useImperativeHandle as useImperativeHandle3 } from "react";
...
var FullscreenModal = ({
  ...
  const pointerDownY = React.useRef(0);
...
function RmgSlideProvider({
  ...
  return /* @__PURE__ */ jsx3(RmgSlideContext.Provider, { value, children });
}
...
function DefaultChevron({
  ...
  const pathPrev = /* @__PURE__ */ jsx4("path", { d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6z" });
  const pathNext = /* @__PURE__ */ jsx4("path", { d: "M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6z" });
  if (axisMain === "y") {
  ...
  const DefaultArrow = ({
    ...
    return /* @__PURE__ */ jsx4(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx4(DefaultChevron, { axisMain, direction: dir, size: 32 })
      }
    );
  };
...
function runFullscreenIntro(args) {
  ...
  if (typeof fs.caption?.render === "function") {
    try {
      ...
      root.render(/* @__PURE__ */ jsx7(Fragment2, { children: captionNode }));
    } catch (err) {
...
function cloneSlide(child, key, elementIndex, cells, enableParallax, imageCountForIdx, lazyLoad, extraStyle, fullscreen, isClone, plyrRefsByIdx) {
  ...
  if (!enableParallax) {
    return /* @__PURE__ */ jsx8("div", { ...shellProps, children: /* @__PURE__ */ jsx8(RmgSlideProvider, { value: ctxVal, children: contentNode }) }, key);
  }
  return /* @__PURE__ */ jsx8("div", { ...shellProps, className: "rmg__slide", children: /* @__PURE__ */ jsx8(RmgSlideProvider, { value: ctxVal, children: /* @__PURE__ */ jsx8("div", { className: "rmg__parallax", children: /* @__PURE__ */ jsx8("div", { className: "rmg__parallax__layer", children: contentNode }) }) }) }, key);
}
var Slider = forwardRef2(function Slider2({
  children,
  imageCount,
  isClick,
  expandableImgRefs,
  ...
  const slides = useRef3([]);
  const visibleImagesRef = useRef3(0);
  const selectedIndex = useRef3(0);
  const sliderX = useRef3(0);
  const sliderVelocity = useRef3(0);
  const isWrapping = useRef3(true);
  const sliderContainer = useRef3(null);
  const prevButtonRef = useRef3(null);
  const nextButtonRef = useRef3(null);
  const dotRefs = useRef3([]);
  const dotsContainerRef = useRef3(null);
  const [clonedChildren, setClonedChildren] = useState([]);
  const clonesCountRef = useRef3(0);
  const [visibleImages, setVisibleImages] = useState(1);
  const [slidesState, setSlidesState] = useState([]);
  const [isMeasured, setIsMeasured] = useState(false);
  const [inView, setInView] = useState(false);
  const [wrap, setWrap] = useState(false);
  const progressHolderRef = useRef3(null);
  const progressInnerRef = useRef3(null);
  const lastProgressRef = useRef3(0);
  const cellToSlideRef = useRef3([]);
  const builtOnceRef = useRef3(false);
  const slideBuildSubs = useRef3(/* @__PURE__ */ new Set());
  const [layoutReady, setLayoutReady] = useState(false);
  const [engineReady, setEngineReady] = useState(false);
  const overlayCaptionRef = useRef3(null);
  const overlayCaptionRootRef = useRef3(null);
  const locationRef = useRef3(null);
  const previousLocationRef = useRef3(null);
  const offsetLocationRef = useRef3(null);
  const targetRef = useRef3(null);
  const bodyRef = useRef3(null);
  const translateRef = useRef3(null);
  const animRef = useRef3(null);
  const limitRef = useRef3(null);
  const pointerDownRef = useRef3(false);
  const isAnimatingRef = useRef3(false);
  const isPointerDown = useRef3(false);
  const isScrolling = useRef3(false);
  const xRef = useRef3(0);
  const dragX = useRef3(0);
  const previousDragX = useRef3(0);
  const dragMoveTime = useRef3(null);
  const boundsRef = useRef3(null);
  const povRef = useRef3(null);
  const cells = useRef3([]);
  const sliderWidth = useRef3(0);
  const hasPositioned = useRef3(false);
  const getSnapTargets = () => (slides.current || []).map((s) => s.target);
  const totalWidth = () => sliderWidth.current || 0;
  const contentSizeRef = useRef3(0);
  const loopLimitRef = useRef3(null);
  const scrollSnapsRef = useRef3([]);
  const scrollContentSizeRef = useRef3(0);
  const scrollLimitRef = useRef3(null);
  const scrollTargetRef = useRef3(null);
  const scrollToRef = useRef3(null);
  const indexCurrentRef = useRef3(null);
  const indexPreviousRef = useRef3(null);
  const layoutRef = useRef3(null);
  const draggingAttr = "data-rmg-drag";
  const activePointerIdRef = useRef3(null);
  const guardsStoreRef = useRef3(null);
  const isHoveringRef = useRef3(false);
  const lastPointerUpTime = useRef3(performance.now() - 1e3);
  const autoScrollPauseUntil = useRef3(0);
  const [buildKey, setBuildKey] = useState(0);
  const loopStableRef = useRef3(null);
  const [geomKey, setGeomKey] = useState(0);
  const lastGeomSigRef = useRef3("");
  const plyrRefsByIdx = useRef3({});
  const lastCloneSigRef = useRef3("");
  const shieldCleanupRef = useRef3(null);
  const shieldRef = useRef3(null);
  ...
  const lastNonZeroHeightRef = useRef3(
  ...
  useEffect6(() => {
    ...
    const ro = new ResizeObserver(() => {
      const rawKids = Children2.toArray(children).filter(isValidElement);
  ...
  useEffect6(() => {
    ...
    if (clonedChildren.length !== Children2.toArray(children).length + imgOffset) return;
  ...
  const centerSlider = useCallback5(() => {
    const track = slider.current;
    if (!track) return;
    const idx = selectedIndex.current || 0;
  ...
  const addShield = useCallback5((timeoutMs) => {
  ...
  const createRipple = useCallback5((container) => {
  ...
  const arrowNodes = /* @__PURE__ */ jsx8(
    RmgArrows,
    {
      axisMain: AX.main,
  ...
  const inner = /* @__PURE__ */ jsxs2(Fragment3, { children: [
    arrowNodes,
    /* @__PURE__ */ jsx8(
      "div",
      {
  ...
  const defaultSliderSkeleton = /* @__PURE__ */ jsx8("div", { className: Slider_default.sliderSkeletonOverlay, "data-rmg-skel-part": "overlay", children: /* @__PURE__ */ jsx8("div", { className: Slider_default.sliderSkeletonRow, "data-rmg-skel-part": "row", children: Array.from({ length: MAX_SKELETONS }).map((_, i) => /* @__PURE__ */ jsx8(
    "div",
    {
  ...
  const introWrapped = normalizedIntro.renderIntro ? /* @__PURE__ */ jsx8("div", { ...baseContainerProps, children: normalizedIntro.renderIntro(
    { active: isReady && inView, containerProps: baseContainerProps },
    inner
  ) }) : /* @__PURE__ */ jsx8("div", { ...baseContainerProps, children: inner });
  return /* @__PURE__ */ jsxs2(Fragment3, { children: [
    responsiveCss && /* @__PURE__ */ jsx8("style", { dangerouslySetInnerHTML: { __html: responsiveCss } }),
    baseCss && /* @__PURE__ */ jsx8("style", { dangerouslySetInnerHTML: { __html: baseCss } }),
    skeletonCss && /* @__PURE__ */ jsx8("style", { dangerouslySetInnerHTML: { __html: skeletonCss } }),
    /* @__PURE__ */ jsxs2(
      "div",
      {
        id: scopeId,
...
function ThumbnailSlider({
  ...
  const scopeId = useId2().replace(/:/g, "-");
  const channelRef = useRef4(indexChannel ?? createIndexChannel());
  const [thumbLong, setThumbLong] = useState2(thumbSize ?? 0);
  const [thumbCross, setThumbCross] = useState2(0);
  const [contentLength, setContentLength] = useState2(0);
  const [containerLength, setContainerLength] = useState2(0);
  const locationRef = useRef4(null);
  const previousLocationRef = useRef4(null);
  const offsetLocationRef = useRef4(null);
  const targetRef = useRef4(null);
  const bodyRef = useRef4(null);
  const translateRef = useRef4(null);
  const animRef = useRef4(null);
  const limitRef = useRef4(null);
  const boundsRef = useRef4(null);
  const povRef = useRef4(null);
  const isAnimatingRef = useRef4(false);
  const prevButtonRef = useRef4(null);
  const nextButtonRef = useRef4(null);
  const pagesRef = useRef4([]);
  const snapModeRef = useRef4("base");
  const pointerDownRef = useRef4(false);
  const isPointerDown = useRef4(false);
  const isClickRef = useRef4(true);
  const xRef = useRef4(0);
  const dragX = useRef4(0);
  const previousDragX = useRef4(0);
  const dragMoveTime = useRef4(null);
  const sliderVelocity = useRef4(0);
  const selectedIndexRef = useRef4(channelRef.current.get().index ?? 0);
  const rawKids = Children3.toArray(children).filter(isValidElement2);
  const count = rawKids.length;
  const baseOffsetRef = useRef4(0);
  const downTargetRef = useRef4(null);
  const [inView, setInView] = useState2(false);
  const [isReady, setIsReady] = useState2(false);
  const readyRafRef = useRef4(null);
  const readyPaintedRef = useRef4(false);
  const contentSizeRef = useRef4(0);
  const loopLimitRef = useRef4(null);
  const scrollSnapsRef = useRef4([]);
  const scrollContentSizeRef = useRef4(0);
  const scrollLimitRef = useRef4(null);
  const scrollTargetRef = useRef4(null);
  const scrollToRef = useRef4(null);
  const indexCurrentRef = useRef4(null);
  const indexPreviousRef = useRef4(null);
  const [buildKey, setBuildKey] = useState2(0);
  const loopStableRef = useRef4(null);
  const [geomKey, setGeomKey] = useState2(0);
  const lastGeomSigRef = useRef4("");
  const [wrap, setWrap] = useState2(false);
  const isWrapping = useRef4(false);
  const clonesCountRef = useRef4(0);
  const visibleThumbsRef = useRef4(1);
  const layoutRef = useRef4(null);
  const thumbCells = useRef4([]);
  const [clonedChildren, setClonedChildren] = useState2([]);
  const lastCloneSigRef = useRef4("");
  const slidesRef = useRef4([]);
  const [slidesState, setSlidesState] = useState2([]);
  const [isMeasured, setIsMeasured] = useState2(false);
  const cellToSlideRef = useRef4([]);
  const sliderWidth = useRef4(0);
  const [layoutReady, setLayoutReady] = useState2(false);
  const prevActiveRef = useRef4(-1);
  const draggingAttr = "data-rmg-drag";
  const activePointerIdRef = useRef4(null);
  const guardsStoreRef = useRef4(null);
  const AX = useMemo2(() => {
  ...
  useEffect7(() => {
    ...
    if (!el) return;
    const ro = new ResizeObserver(() => {
      const rawKids2 = Children3.toArray(children).filter(isValidElement2);
  ...
  const normalizedLoading = useMemo2(() => {
    const src = loadingOptions ?? {};
    return {
      isLoading: src.isLoading,
      skeletonCount: src.skeletonCount,
  ...
  const normalizedIntro = useMemo2(() => {
    const src = introOptions ?? {};
    return {
      renderIntro: src.renderIntro,
      staggerMs: src.staggerMs ?? 40,
  ...
  const { cssText: skeletonCss, ssrBaseCount: skeletonCountBase } = useMemo2(() => {
    return buildScopedSkeletonCountCss({
      scopeId,
      responsiveCount: normalizedLoading.skeletonCount,
      fallbackCount,
  ...
  const defaultThumbSkeleton = /* @__PURE__ */ jsx9("div", { className: ThumbnailSlider_default.thumbSkeletonOverlay, "data-rmg-skel-part": "overlay", children: /* @__PURE__ */ jsx9(
    "div",
    {
      ...
      children: Array.from({ length: MAX_SKELETONS }).map((_, i) => /* @__PURE__ */ jsx9(
        "div",
        {
  ...
  const createRipple = useCallback6((container) => {
    if (!effectiveRippleEnabled || !container) return;
    const old = container.querySelector("[data-rmg-ripple]");
    if (old) old.remove();
    const rect = container.getBoundingClientRect();
  ...
  const arrowNodes = /* @__PURE__ */ jsx9(
    RmgArrows,
    {
      axisMain: AX.main,
      clientKey: AX.clientKey,
  ...
  const inner = /* @__PURE__ */ jsxs3(Fragment4, { children: [
    arrowNodes,
    /* @__PURE__ */ jsx9("div", { ref: trackRef, style: trackStyle, children: introChildren })
  ] });
  const root = /* @__PURE__ */ jsxs3(
    "div",
    {
      ...baseContainerProps,
      ref: containerRef,
  ...
  return /* @__PURE__ */ jsxs3(Fragment4, { children: [
    skeletonCss && /* @__PURE__ */ jsx9("style", { dangerouslySetInnerHTML: { __html: skeletonCss } }),
    root
  ] });
}
...
function FullscreenThumbnailSlider({
  ...
  const channelRef = useRef5(createIndexChannel(fsSub.get(), "animated"));
  useEffect8(() => {
  ...
  return /* @__PURE__ */ jsx10("div", { style: wrapperStyle, className, children: /* @__PURE__ */ jsx10(
    ThumbnailSlider,
    {
      position,
      thumbnailWidth,
...
function GridLayout({
  ...
  const defaultGridSkeleton = /* @__PURE__ */ jsx11("div", { className: Gallery_default.gridSkeletonOverlay, children: /* @__PURE__ */ jsx11(
    "div",
    {
      className: [Gallery_default.gridSkeletonGrid, grid.rootClassName || ""].filter(Boolean).join(" "),
      style: gridStyle,
      children: Array.from({ length: skeletonCount }).map((_, i) => /* @__PURE__ */ jsx11("div", { className: Gallery_default.gridSkeletonItem }, `rmg-grid-skel-${i}`))
    }
  ) });
  ...
  const inner = /* @__PURE__ */ jsx11("div", { ref: gridRootRef, ...containerProps, children: gridChildren });
...
var Masonry = ({
  ...
  return /* @__PURE__ */ jsx12(
    RootComponent,
    {
      ...
      children: columnsChildren.map((colChildren, i) => /* @__PURE__ */ jsx12(
        "div",
        {
...
var DefaultMasonrySkeleton = ({
  ...
  return /* @__PURE__ */ jsx12(
    "div",
    {
      ...
      children: cols.map((children, i) => /* @__PURE__ */ jsx12(
        "div",
        {
...
function MasonryLayout({
  ...
  const defaultMasonrySkeleton = /* @__PURE__ */ jsx13("div", { className: Gallery_default.gridSkeletonOverlay, children: /* @__PURE__ */ jsx13(
...
function EntrySkeletonCard() {
  return /* @__PURE__ */ jsxs6("article", { className: Gallery_default.entrySkeletonCard, children: [
    /* @__PURE__ */ jsxs6("div", { className: Gallery_default.entrySkeletonHeader, children: [
      /* @__PURE__ */ jsx14("div", { className: `${Gallery_default.entrySkeletonAvatar} ${Gallery_default.entrySkeletonShimmer}` }),
      /* @__PURE__ */ jsxs6("div", { className: Gallery_default.entrySkeletonLines, children: [
        /* @__PURE__ */ jsx14("div", { className: `${Gallery_default.entrySkeletonLineShort} ${Gallery_default.entrySkeletonShimmer}` }),
        /* @__PURE__ */ jsx14("div", { className: `${Gallery_default.entrySkeletonLineLong} ${Gallery_default.entrySkeletonShimmer}` })
      ] })
    ] }),
    /* @__PURE__ */ jsxs6("div", { className: Gallery_default.entrySkeletonBody, children: [
      /* @__PURE__ */ jsx14("div", { className: `${Gallery_default.entrySkeletonLineLong} ${Gallery_default.entrySkeletonShimmer}` }),
      /* @__PURE__ */ jsx14("div", { className: `${Gallery_default.entrySkeletonLineMedium} ${Gallery_default.entrySkeletonShimmer}` })
    ] }),
    /* @__PURE__ */ jsx14("div", { className: `${Gallery_default.entrySkeletonMedia} ${Gallery_default.entrySkeletonShimmer}` })
  ] });
}
...
function EntryList({
  ...
  const entryRows = !len ? null : items.map((entry, entryIndex) => {
    ...
    return /* @__PURE__ */ jsxs7(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx15("div", { className: Gallery_default.entrySkeletonWrap, "aria-hidden": showSkeleton ? void 0 : true, children: /* @__PURE__ */ jsx15(EntrySkeletonCard, {}) }),
          shouldMountContent ? /* @__PURE__ */ jsx15("div", { className: Gallery_default.entryInner, children: contentNode }) : null
        ]
      },
  ...
  const inner = /* @__PURE__ */ jsx15("div", { ...containerProps, children: entryRows });
...
function useFsEntryOverlay(args) {
  ...
  const renderEntryOverlayForIndex = React17.useCallback(
    (index) => {
      ...
      if (!rootRef.current) {
        rootRef.current = createRoot2(mount);
...
var Plyr = React24.forwardRef(function PlyrForwarded(props, ref) {
  return /* @__PURE__ */ jsx19(LazyPlyr, { ...props, ref });
});
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs8(
          "div",
          {
            ...
            children: [
              captionNode && captionFirst && /* @__PURE__ */ jsx20(
                "div",
                {
              ...
              /* @__PURE__ */ jsx20(
                "div",
                {
                  ...
                  children: item.kind === "video" ? /* @__PURE__ */ jsx20(
                    "div",
                    {
                      "data-index": index,
...
function useOpenEpoch(open) {
  const [epoch, setEpoch] = useState10(0);
  const prev = useRef14(open);
  useEffect21(() => {
...
var Gallery = React26.forwardRef(function Gallery2({
  children,
  fullscreen,
  slider,
  layout = "slider",
  ...
  const indexChannel = useMemo11(() => createIndexChannel(), []);
  const fsSub = useMemo11(() => createFullscreenSliderSub(0), []);
  const [slideIndex, setSlideIndex] = useState10(0);
  const isClick = useRef14(false);
  const isZoomClick = useRef14(false);
  const imageRefs = useRef14([]);
  const [showFullscreenSlider, setShowFullscreenSlider] = useState10(false);
  const fullscreenSliderApi = useRef14(null);
  const isZooming = useRef14(false);
  const expandableImgRefs = useRef14([]);
  const overlayDivRef = useRef14(null);
  const duplicateImgRef = useRef14(null);
  const closeButtonRef = useRef14(null);
  const counterRef = useRef14(null);
  const leftChevronRef = useRef14(null);
  const rightChevronRef = useRef14(null);
  const [showFullscreenModal, setShowFullscreenModal] = useState10(false);
  const [wrappedItems, setWrappedItems] = useState10([]);
  const windowSize = useWindowSize();
  const scaleRef = useRef14(1);
  const panRef = useRef14({ x: 0, y: 0 });
  const previousZoom = useRef14({ x: 0, y: 0 });
  const sliderForFullscreen = useRef14(null);
  const slidesForFullscreen = useRef14([]);
  const visibleImagesForFullscreen = useRef14(1);
  const selectedIndexForFullscreen = useRef14(0);
  const sliderXForFullscreen = useRef14(0);
  const sliderVelocityForFullscreen = useRef14(0);
  const isWrappingForFullscreen = useRef14(false);
  const fsIndexRef = useRef14(fsSub.get());
  const [fsFadeOpening, setFsFadeOpening] = useState10(false);
  const entryMapRef = useRef14(null);
  const entryFlatIndexRef = useRef14(null);
  const fsOwnersRef = useRef14([]);
  const [closingModal, setClosingModal] = useState10(false);
  const changingSlides = useRef14(false);
  const [isZoomed, setIsZoomed] = useState10(false);
  const isZoomedRef = useRef14(false);
  const currentImage = useRef14(null);
  const aspectRatioRef = useRef14(1);
  const axisRef = useRef14(null);
  const pointerDownRef = useRef14(false);
  const interactionModeRef = useRef14("idle");
  const locX = useRef14(null);
  const locY = useRef14(null);
  const prevX = useRef14(null);
  const prevY = useRef14(null);
  const offX = useRef14(null);
  const offY = useRef14(null);
  const tgtX = useRef14(null);
  const tgtY = useRef14(null);
  const sliderApiRef = useRef14(null);
  const entrySliderRefs = useRef14([]);
  const overlayCaptionRef = useRef14(null);
  const overlayCaptionRootRef = useRef14(null);
  const fsThumbContainerRef = useRef14(null);
  const epoch = useOpenEpoch(showFullscreenModal);
  const [isReady, setIsReady] = useState10(false);
  const suppressLoopRef = useRef14(false);
  const shieldCleanupRef = React26.useRef(null);
  const shieldRef = useRef14(null);
  const bodyX = useRef14(null);
  const bodyY = useRef14(null);
  const boundsX = useRef14(null);
  const boundsY = useRef14(null);
  const isAnimatingRef = useRef14(false);
  const animRef = useRef14(null);
  const wrappedModePlyrRefs = useRef14([]);
  const singleModePlyrRefs = useRef14([]);
  const suppressNextClickRef = useRef14(false);
  const cells = useRef14([]);
  const idSeqRef = useRef14(0);
  const asArray = (x) => Array.isArray(x) ? x : [x];
  const newId = useCallback13(() => `rmg-${++idSeqRef.current}`, []);
  function nodeFromMedia(m) {
    if (m.kind === "image") return /* @__PURE__ */ jsx21("img", { src: m.src, alt: m.alt ?? "" });
    if (m.kind === "video") {
      return /* @__PURE__ */ jsx21("video", { src: m.src, controls: true, preload: "metadata" });
    }
    return null;
  }
  const initialCells = useMemo11(() => {
    const kids = React26.Children.toArray(children);
  ...
  const cellsRef = React26.useRef(initialCells);
  const [cellsState, setCellsState] = React26.useState(initialCells);
  const effectiveBreakpoints = useMemo11(
  ...
  const { flattenedEntryMedia, flattenedEntryMap } = useMemo11(() => {
  ...
  const [normalizedItems, setNormalizedItems] = useState10(() => {
  ...
  function usePredecodeImages(urls, enabled) {
    const [ready, setReady] = useState10(
  ...
  const fullscreenImageUrls = useMemo11(
  ...
  const sliderImageUrls = useMemo11(
    () => normalizedItems.filter((m) => m.kind === "image").map((m) => m.src),
    [normalizedItems]
  );
  ...
  const setScale = useCallback13((newScale) => {
  ...
  const attachEntrySliderRef = useCallback13(
    (entryIndex) => (instance) => {
  ...
  function cellsToMediaItems(next) {
    const extract = (node) => {
      ...
      if (p.children) {
        for (const child of React26.Children.toArray(p.children)) {
  ...
  const renderedCells = React26.useMemo(() => {
    return cellsState.map((c) => {
      const n = c.node;
      return React26.isValidElement(n) ? React26.cloneElement(n, { key: c.id }) : /* @__PURE__ */ jsx21("span", { style: { display: "block" }, children: n }, c.id);
    });
  }, [cellsState]);
  useEffect21(() => {
    if (typeof window === "undefined") return;
  ...
  const addShield = useCallback13((timeoutMs) => {
    shieldCleanupRef.current?.();
    const teardown = shieldRef.current?.add(timeoutMs);
    shieldCleanupRef.current = teardown ?? null;
  }, []);
  const openFullscreenAt = useCallback13(
    (gridIndex, originEl) => {
  ...
  const gridLoading = useMemo11(() => normalizeLoading(gridObject.loading), [gridObject.loading]);
  const gridIntro = useMemo11(() => normalizeIntro(gridObject.intro), [gridObject.intro]);
  const masonryLoading = useMemo11(() => normalizeLoading(masonryObject.loading), [masonryObject.loading]);
  const masonryIntro = useMemo11(() => normalizeIntro(masonryObject.intro), [masonryObject.intro]);
  const resolvedCellsPerSlide = useMemo11(() => {
  ...
  const openFullscreenAtStable = useCallback13(
    (index) => {
      openFullscreenAt(index);
    },
    [openFullscreenAt]
  );
  const registerExpandableImgStable = useCallback13(
    (index, node) => {
      registerExpandableImg(index, node);
    },
    [registerExpandableImg]
  ...
  const masonryChildren = useMemo11(() => {
  ...
  const rebuildPanBodies = useCallback13(() => {
    rebuildPanBodiesFn({
      fs,
      currentImage,
      scaleRef,
  ...
  const resolvedThumbPos = useMemo11(() => {
  ...
  const fsResolvedThumbPos = useMemo11(
  ...
  return /* @__PURE__ */ jsxs9(Fragment7, { children: [
    /* @__PURE__ */ jsxs9("div", { className: root?.className, style: root?.style, children: [
      layout === "slider" && (resolvedThumbPos === "top" || resolvedThumbPos === "left") && /* @__PURE__ */ jsx21(
        ThumbnailSlider,
        {
          indexChannel,
      ...
      /* @__PURE__ */ jsx21("div", { className: container?.className, style: container?.style, children: layout === "slider" ? /* @__PURE__ */ jsx21(
        Slider_default2,
        {
        ...
        EntryList,
        {
          ...
          renderMediaContainer: ({ entryIndex, mediaNodes }) => {
            if (entriesObject.mediaLayout === "masonry") {
              return /* @__PURE__ */ jsx21("div", { className: Gallery_default.entryMasonry, children: /* @__PURE__ */ jsx21(
                MasonryLayout,
                {
                  items: mediaNodes,
                  masonry: masonryObject,
      ...
      layout === "slider" && (resolvedThumbPos === "bottom" || resolvedThumbPos === "right") && /* @__PURE__ */ jsx21(
        ThumbnailSlider,
        {
          indexChannel,
          position: resolvedThumbPos,
    ...
    fs.enabled && /* @__PURE__ */ jsxs9(
      FullscreenModal_default,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs9(
            "div",
            {
              ...
              children: [
                ...
                fs.thumbnails?.layout?.position !== void 0 && /* @__PURE__ */ jsx21(
                  "div",
                  {
                    ...
                    children: normalizedItems.length > 1 && /* @__PURE__ */ jsx21(
          ...
          showFullscreenModal && layout === "entries" ? /* @__PURE__ */ jsx21(FsEntryOverlayMount, { setMountEl: setFsEntryOverlayMountEl }) : null
        ]
      }
    )
  ] });
