import { T as ThumbnailPosition } from './types-DTSXOwzF.mjs';
import * as React$1 from 'react';
import { MediaItem } from './media.mjs';
import { E as ElementStyle, h as SliderSkipSnaps, k as SliderVirtualizationOptions, C as CrossFade, M as FullscreenOpenMethod } from './types-CGPPAn9i.mjs';
...
import { I as InfiniteScrollRootSource } from './infiniteScrollTrigger-BluBDW9o.mjs';
import { c as FullscreenThumbnailSlotLayout } from './types-BtQK91-K.mjs';
...
type EntriesVirtualizationOptions = {
    ...
    gap?: number;
    overscan?: number;
    scrollRoot?: Element | React.RefObject<Element | null> | (() => Element | null) | null;
};
...
type FullscreenRuntimeProps = {
    ...
    entryRootRef?: React$1.RefObject<HTMLDivElement | null>;
...
type FullscreenMountStrategy = "always" | "open";
...
type FullscreenZoomPanBoundsMode = "media" | "layout";
...
type FullscreenCloseOptions = {
    immediate?: boolean;
};
type FullscreenDialogTransitionOptions = {
    durationMs?: number;
    easing?: string;
};
...
type FullscreenRuntimeFeatures = {
    useZoomPanRuntime?: (args: any) => {
        ...
        forceResetZoom?: () => void;
        prepareZoomOutForClose?: (options?: {
            durationMs?: number;
        }) => Promise<void> | void;
...
export type { FullscreenCounter as $, FullscreenVideoOptions as A, FullscreenZoomPanBoundsMode as B, FullscreenZoomPanOptions as C, FsCaptionPlacement as D, EntriesHandle as E, FullscreenCaptionOptions as F, FsIntroRequest as G, ResponsiveLength as H, ResponsiveLengthValue as I, EntryItem as J, EntryMediaRenderArgs as K, EntryOverlayRenderArgs as L, MediaEntryLink as M, EntryOverlayStyle as N, EntryMediaLayout as O, PanAxisType as P, EntryCardRenderArgs as Q, ResponsiveCaptionPlacement as R, SlideOwner as S, EntrySkeletonResolverArgs as T, EntriesLoadingOptions as U, RevealOptions as V, EntrySkeletonRenderArgs as W, EntriesDataMode as X, EntriesPluginOptionsByKind as Y, FullscreenClose as Z, FullscreenArrows as _, EntriesInfiniteScrollOptions as a, FsCaptionRenderArgs as a0, FSImageRender as a1, ResponsivePosition as a2, EntriesLayout as b, EntriesLoadMoreOptions as c, EntriesOptions as d, EntriesPaginationOptions as e, EntriesPlugin as f, EntriesPluginKind as g, EntriesVirtualizationOptions as h, FullscreenCloseOptions as i, FullscreenCloseScrollContext as j, FullscreenCloseScrollEnabled as k, FullscreenCloseScrollOptions as l, FullscreenCloseScrollTiming as m, FullscreenControlsOptions as n, FullscreenCrossfadeOptions as o, FullscreenDialogTransitionOptions as p, FullscreenDialogOptions as q, FullscreenEffectsOptions as r, FullscreenIntroPathTiming as s, FullscreenLazyLoadOptions as t, FullscreenMobileDetectionContext as u, FullscreenMountStrategy as v, FullscreenOptions as w, FullscreenPlugin as x, FullscreenPluginKind as y, FullscreenSliderOptions as z };
