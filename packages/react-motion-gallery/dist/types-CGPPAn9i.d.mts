...
type SliderUnderflowAlign = "start" | "center" | "end";
type SliderLayout = {
    gap?: number;
...
type SliderScrollbarCrossfade = boolean | {
    enabled?: boolean;
    durationMs?: number;
    easing?: string;
};
...
type SliderCrossfadeCoreApi = {
    ...
    restoreMotionState: (state: SliderMotionSnapshot, options?: {
        syncVirtual?: boolean;
    }) => void;
    renderTrackAtLocation: (location: number, options?: {
        syncVirtual?: boolean;
    }) => void;
...
interface SliderCoreHandle {
    ...
    _scrollToProgressFromUi?: (progress: number, options?: {
        crossfade?: boolean;
        durationMs?: number;
        easing?: string;
    }) => boolean;
...
export { type ArrowRenderArgs as A, type SliderLoadingOptions as B, type CrossFade as C, type SliderParallax as D, type ElementStyle as E, type SliderProgress as F, type GalleryApi as G, type SliderRipple as H, type IndexMode as I, type SliderScale as J, type SliderScrollbar as K, type FullscreenOpenRequest as L, type FullscreenOpenMethod as M, type ResponsiveHeightRule as R, type SliderAutoHeight as S, type GalleryCoreApi as a, type GalleryLayoutApi as b, createSliderIndexChannel as c, type CrossFadeWheel as d, type CrossFadeWheelOptions as e, type SliderAutoPlayTimer as f, type SliderRevealOptions as g, type SliderSkipSnaps as h, type SliderSkipSnapsOptions as i, type SliderUnderflowAlign as j, type SliderVirtualizationOptions as k, type SliderOptions as l, type SliderHandle as m, type SliderApi as n, type SliderItemsApi as o, type SliderNodeInput as p, type SliderRemoveTarget as q, type SliderPlugin as r, type SliderPluginKind as s, type SliderIndexChannel as t, type SliderArrows as u, type SliderAutoPlay as v, type SliderAutoScroll as w, type SliderDots as x, type SliderFade as y, type SliderLazyLoadOptions as z };
